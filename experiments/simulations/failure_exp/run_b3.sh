...
args="-all ${topo_path}/{2}.dot ${demand_path}/{2}-matrix/{2}_mergelen_12 ${demand_path}/{2}-matrix/{2}_mergelen_12  ${host_path}/{2}.hosts -num-tms ${num_tm} -deloop -scalesyn -budget ${budget} -scale {1} ${fail} -out ${out_dir}"
