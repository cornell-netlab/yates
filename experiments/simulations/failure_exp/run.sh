...
num_tm=24
budget=3
fail="-fail-time 0 -lr-delay 1 -num-fail {3}"
fail_name=$(echo "${fail}" | tr '[[:space:]]' '_')
out_dir="test_fail_{2}_scale_{1}_budget_${budget}_numtm_${num_tm}_${fail_name}"
