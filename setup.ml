...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6ec24f27bdba5fb15aafe879b53bd13f) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "routing"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "Kulfi_Controller.ml"
                   });
               Executable
                 ({
                     cs_name = "unittest";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ïx\rΩ»B£\128\007\156\138∂€ÙSq";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
